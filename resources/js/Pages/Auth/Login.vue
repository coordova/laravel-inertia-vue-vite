        ...
        <section class="bg-white p-8 rounded-xl max-w-md mx-auto border">
            ...
            <form @submit.prevent="submit">
                <div class="mb-6">
                    ...
                    <input v-model="form.email" type="text" name="email" id="email" required class="border rounded p-2 w-full">
                    <div v-if="form.errors.email" v-text="form.errors.email" class="text-red-500 text-xs mt-1"></div>
                </div>
                <div class="mb-6">
                    <label for="password" class="block mb-2 uppercase font-bold text-xs text-gray-700">Password</label>
                    <input v-model="form.password" type="password" name="password" id="password" class="border rounded p-2 w-full">
